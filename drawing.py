...
class Drawing:
    ...
    def draw_crosshair(self):
        ...
        # Отрисовка прицела
        pygame.draw.line(self.sc, crosshair_color, (center_x - crosshair_size, center_y),
                         (center_x + crosshair_size, center_y), 2)
        pygame.draw.line(self.sc, crosshair_color, (center_x, center_y - crosshair_size),
    ...
    def menu(self):
        ...
        while self.menu_trigger:
            ...
            self.sc.blit(start, (button_start.centerx - 130, button_start.centery - 45))
            ...
            color = randrange(40)
            label = label_font.render('Half-Life', 1, (color, color, color))
            self.sc.blit(label, (50, -10))
